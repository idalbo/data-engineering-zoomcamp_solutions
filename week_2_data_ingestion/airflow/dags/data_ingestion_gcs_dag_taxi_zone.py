...
with DAG(
    dag_id="data_ingestion_gcs_dag_taxi_zone",
    ...
    clean_up_local_task = BashOperator(
        task_id="clean_up_local_task",
        bash_command=f"rm {path_to_local_home}/{dataset_file} {path_to_local_home}/{parquet_file}"
    )

    download_dataset_task >> format_to_parquet_task >> local_to_gcs_task >> bigquery_external_table_task >> clean_up_local_task
